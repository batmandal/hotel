    ...
    <div className="flex h-screen w-full bg-gray-50 overflow-hidden font-sans flex-col md:flex-row">
      ...
      >
        ...
        <div className="p-4 border-t border-gray-100">
          ...
          <button onClick={() => setShowLogoutConfirm(true)} className="mt-1 w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium text-red-600 hover:bg-red-50">
