    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 py-12 sm:px-12 lg:px-16">
        <div className="mx-auto w-full max-w-sm">
          <Link
            href="/"
            className="inline-flex items-center text-sm text-teal-600 hover:text-teal-700 focus:outline-none focus:ring-2 focus:ring-teal-500 rounded mb-6"
          >
          ...
          <p className="mt-2 text-sm text-gray-500">
            {locale === "mn"
              ? "Тавтай морил. Бүртгэлтэй хаягаараа нэвтрэнэ үү."
          ...
          <p className="mt-6 text-center text-sm text-gray-500">
            {locale === "mn"
              ? "Туршилт: дурын имэйл, нууц үг оруулаад үргэлжлүүлнэ."
